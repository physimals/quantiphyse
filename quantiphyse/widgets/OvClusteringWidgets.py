...
class OvCurveClusteringWidget(QpWidget):
    ...
    def __init__(self, **kwargs):
        super(OvCurveClusteringWidget, self).__init__(name="Overlay Cluster", icon="clustering", desc="Generate clusters from overlays", group="DEFAULT", **kwargs)
    ...
    def run_merge(self):
        ...
        # signal the change
        self.ivm.add_roi(roi, name="overlay_clusters", make_current=True)
        self.update_voxel_count()
...
QP_WIDGETS = [OvCurveClusteringWidget]
