...
Orton subfunction 
*/
double f2(double time1, double alpha, double m1)
{
...
*/
double compute_SE_from_Gd_concentration2(double Ct, double R1, double R2, double flip_angle, double TR, double TE, double T10)
{
...
*/
double Ct_with_orton_aif2(double a1, double a2, double m1, double m2, double offset, 
	double Ktrans, double kep, double time1, double offset_pk)
{
...
double Tofts_model_with_orton_aif_offset(double t, const double *x, 
	params_for_optimisation P1)
{
    ...
    Ct = Ct_with_orton_aif2(A1, A2, m1, m2, offset, Ktrans, kep, t, offset_pk);
    ...
    SE = compute_SE_from_Gd_concentration2(Ct, R1, R2, flip_angle, TR, TE, T10);
