/* Generated by Cython 0.20.2 on Thu Jul  3 15:21:12 2014 */
...
/* "analysis/pkmodel_cpp/pk.pyx":26
 * 
...
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_6set_parameters(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self, PyObject *__pyx_v_R1in, PyObject *__pyx_v_R2in, PyObject *__pyx_v_dce_flip_anglein, PyObject *__pyx_v_dce_TRin, PyObject *__pyx_v_dce_TEin, PyObject *__pyx_v_Dosein); /* proto */
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_8rinit(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self, PyObject *__pyx_v_model1); /* proto */
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_10run(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self, PyObject *__pyx_v_pause1); /* proto */
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_12get_parameters(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_14get_fitted_curve(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_16get_residual(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self); /* proto */
...
/* "analysis/pkmodel_cpp/pk.pyx":28
 * cdef class PyPk:
 *     cdef Pkrun2 *thisptr      # hold a C++ instance which we're wrapping
 *     def __cinit__(self, vector [double] t1, vector[vector[double]] y1, vector[double] T101):             # <<<<<<<<<<<<<<
...
static int __pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    __pyx_v_t1 = __pyx_convert_vector_from_py_double(values[0]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_y1 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_double_3e_(values[1]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_T101 = __pyx_convert_vector_from_py_double(values[2]); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
...
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_5set_bounds(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_lb1)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("set_bounds", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "set_bounds") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("set_bounds", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 */
  __pyx_t_1 = __pyx_convert_vector_from_py_double(__pyx_v_ub1); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __pyx_convert_vector_from_py_double(__pyx_v_lb1); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* Python wrapper */
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_7set_parameters(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_7set_parameters(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_R2in)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("set_parameters", 1, 6, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dce_flip_anglein)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_parameters", 1, 6, 6, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dce_TRin)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_parameters", 1, 6, 6, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dce_TEin)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_parameters", 1, 6, 6, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Dosein)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_parameters", 1, 6, 6, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "set_parameters") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("set_parameters", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("analysis.pkmodel_cpp.pk.PyPk.set_parameters", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_6set_parameters(((struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *)__pyx_v_self), __pyx_v_R1in, __pyx_v_R2in, __pyx_v_dce_flip_anglein, __pyx_v_dce_TRin, __pyx_v_dce_TEin, __pyx_v_Dosein);
...
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_6set_parameters(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self, PyObject *__pyx_v_R1in, PyObject *__pyx_v_R2in, PyObject *__pyx_v_dce_flip_anglein, PyObject *__pyx_v_dce_TRin, PyObject *__pyx_v_dce_TEin, PyObject *__pyx_v_Dosein) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  double __pyx_t_2;
 ...
 */
  __pyx_t_1 = __pyx_PyFloat_AsDouble(__pyx_v_R1in); if (unlikely((__pyx_t_1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __pyx_PyFloat_AsDouble(__pyx_v_R2in); if (unlikely((__pyx_t_2 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_v_dce_flip_anglein); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_4 = __pyx_PyFloat_AsDouble(__pyx_v_dce_TRin); if (unlikely((__pyx_t_4 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_5 = __pyx_PyFloat_AsDouble(__pyx_v_dce_TEin); if (unlikely((__pyx_t_5 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_6 = __pyx_PyFloat_AsDouble(__pyx_v_Dosein); if (unlikely((__pyx_t_6 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* Python wrapper */
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_9rinit(PyObject *__pyx_v_self, PyObject *__pyx_v_model1); /*proto*/
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_9rinit(PyObject *__pyx_v_self, PyObject *__pyx_v_model1) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("rinit (wrapper)", 0);
  __pyx_r = __pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_8rinit(((struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *)__pyx_v_self), ((PyObject *)__pyx_v_model1));
...
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_8rinit(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self, PyObject *__pyx_v_model1) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_lineno = 0;
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_model1); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* Python wrapper */
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_11run(PyObject *__pyx_v_self, PyObject *__pyx_v_pause1); /*proto*/
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_11run(PyObject *__pyx_v_self, PyObject *__pyx_v_pause1) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("run (wrapper)", 0);
  __pyx_r = __pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_10run(((struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *)__pyx_v_self), ((PyObject *)__pyx_v_pause1));
...
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_10run(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self, PyObject *__pyx_v_pause1) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_pause1); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_self->thisptr->run(__pyx_t_1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* Python wrapper */
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_13get_parameters(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_13get_parameters(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_parameters (wrapper)", 0);
  __pyx_r = __pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_12get_parameters(((struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *)__pyx_v_self));
...
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_12get_parameters(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_double_3e_(__pyx_v_self->thisptr->get_parameters()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* Python wrapper */
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_15get_fitted_curve(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_15get_fitted_curve(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_fitted_curve (wrapper)", 0);
  __pyx_r = __pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_14get_fitted_curve(((struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *)__pyx_v_self));
...
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_14get_fitted_curve(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_std_3a__3a_vector_3c_double_3e_(__pyx_v_self->thisptr->get_fitted_curve()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_17get_residual(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_17get_residual(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_residual (wrapper)", 0);
  __pyx_r = __pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_16get_residual(((struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *)__pyx_v_self));
...
static PyObject *__pyx_pf_8analysis_11pkmodel_cpp_2pk_4PyPk_16get_residual(struct __pyx_obj_8analysis_11pkmodel_cpp_2pk_PyPk *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_double(__pyx_v_self->thisptr->get_residual()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods_8analysis_11pkmodel_cpp_2pk_PyPk[] = {
  ...
  {__Pyx_NAMESTR("set_parameters"), (PyCFunction)__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_7set_parameters, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("rinit"), (PyCFunction)__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_9rinit, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("run"), (PyCFunction)__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_11run, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("get_parameters"), (PyCFunction)__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_13get_parameters, METH_NOARGS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("get_fitted_curve"), (PyCFunction)__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_15get_fitted_curve, METH_NOARGS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("get_residual"), (PyCFunction)__pyx_pw_8analysis_11pkmodel_cpp_2pk_4PyPk_17get_residual, METH_NOARGS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_8analysis_11pkmodel_cpp_2pk_PyPk) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_8analysis_11pkmodel_cpp_2pk_PyPk.tp_print = 0;
  if (__Pyx_SetAttrString(__pyx_m, "PyPk", (PyObject *)&__pyx_type_8analysis_11pkmodel_cpp_2pk_PyPk) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
