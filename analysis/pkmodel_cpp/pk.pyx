...
# distutils: sources = pkrun2.cpp Optimizer_class.cpp ToftsOrton.cpp ToftsOrtonOffset.cpp ToftsWeinOffset.cpp ToftsWeinOffsetVp.cpp lmlib/lmcurve.cpp lmlib/lmmin.cpp
# distutils: include_dirs = lmlib
